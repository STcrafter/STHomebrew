...
},
{
  ...
  {
    "name": "Зомби",
    "description": "Стандартный зомби, поднимаемый из трупа КР ≤ 1. КД 8, ХП 22, скорость 20 фт. Особенности: Стойкость нежити.",
    "statblock_id": "zombie_necr",  // ID монстра в monsters.js (если есть)// опционально
  },
  {
    "name": "Скелет",
    "description": "Боевой скелет, сохраняющий некоторые навыки оригинала. КД 13, ХП 13, скорость 30 фт.",
    "statblock_id": "skeleton_necr",
  },
  {
    "name": "Дух",
    "description": "Бестелесный дух, способный к телепатии и заклинаниям. КД 12, ХП 10, скорость 0 фт., полёт 40 фт.",
    "statblock_id": "spirit_necr"
  }
],
  "tables": [
    {
      "title":"Таблица класса",
      "headers": ["Уровень", "Бонус мастерства", "Особенности", "Макс. ОП", "Прислужники"],
      "rows": [
